...
The mixed model classifier uses the scPred framework (ref: https://github.com/powellgenomicslab/scPred) for cell annotation transfer. The function provided below has been optimized for the single cell reference dataset. 
