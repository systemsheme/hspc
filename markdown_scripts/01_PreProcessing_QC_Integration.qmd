...
datalist[['h1']] <- read.table('Healthy1-WTA-ADT_RSEC_MolsPerCell.csv', sep = ",", header = T)
datalist[['h2']]  <- read.table('Healthy2-WTA-ADT_RSEC_MolsPerCell.csv', sep = ",", header = T)
datalist[['h3']]  <- read.table('Healthy3-WTA-ADT_RSEC_MolsPerCell.csv', sep = ",", header = T)
